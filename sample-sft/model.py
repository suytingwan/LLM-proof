...
class EntailmentVerifier(pl.LightningModule):
    ...
    def validation_step(self, batch: Batch, batch_idx: int) -> None:
        decode_conclusion = self.generate_conclusion(batch["input_fake_seq_convert"])
        decode_embedding = score_model.encode(decode_conclusion)
        hypothesis_embedding = score_model.encode(batch["hypothesis_sample"])
        score = util.dot_score(hypothesis_embedding, decode_embedding)
