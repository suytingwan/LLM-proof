...
class StepwiseDataset(Dataset):
    ...
    def collate(self, examples: List[Example]) -> Batch:
        ...
        inp = [".".join(ex["input_fake_seq"][i]) for i in range(len(ex["input_fake_seq"]))]
        return {
        ...
        for ex in examples:
            ...
            for i, int_node in enumerate(get_internal_nodes(tree)):
                ...
                for goal_node in ancestors:
                    ...
                    seen_leaves = proof.check_seen(partial_proof)
                    ex_new["input_fake_seq"], ex_new["input_fake_ident"] = create_synthetic_seq(int_node_tmp, context, seen_leaves)
...
if __name__ == "__main__":
    path_train = "/home/psuay/code/NLProofS/data/entailment_trees_emnlp2021_data_v3/dataset/task_2/train.jsonl"
    path_val = "/home/psuay/code/NLProofS/data/entailment_trees_emnlp2021_data_v3/dataset/task_2/dev.jsonl"
    print(path_train)
